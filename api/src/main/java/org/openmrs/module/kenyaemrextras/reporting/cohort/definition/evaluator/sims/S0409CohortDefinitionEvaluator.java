...
import org.openmrs.module.kenyaemrextras.reporting.cohort.definition.sims.S0316CohortDefinition;
import org.openmrs.module.kenyaemrextras.reporting.cohort.definition.sims.S0408CohortDefinition;
import org.openmrs.module.kenyaemrextras.reporting.cohort.definition.sims.S0409CohortDefinition;
...
/**
 * Evaluator for CohortDefinition: HIV-positive Pregnant and breastfeeding patients : On ART >=12
 * months
 */
@Handler(supports = { S0409CohortDefinition.class })
public class S0409CohortDefinitionEvaluator implements CohortDefinitionEvaluator {
	...
	public EvaluatedCohort evaluate(CohortDefinition cohortDefinition, EvaluationContext context) throws EvaluationException {
		...
		S0409CohortDefinition definition = (S0409CohortDefinition) cohortDefinition;
		...
		String qry = SimsReportQueries.txCurrPregnantAndBreastfeedingOnART12MonthsQuery();

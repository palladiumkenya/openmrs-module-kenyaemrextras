...
import org.openmrs.module.kenyaemrextras.reporting.data.definition.mortalityAuditTool.CrAgTestResultDataDefinition;
...
/**
 * Evaluates CrAgTestResultDataDefinition
 */
@Handler(supports = CrAgTestResultDataDefinition.class, order = 50)
public class CrAgTestResultDataEvaluator implements PersonDataEvaluator {
	...
	public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context)
		...
		String qry = "select a.patient_id,\n"
		        + "       case a.crag_test_results when 703 then 'Pos' when 664 then 'Neg' when 1067 then 'Unknown' end as crag_test_results\n"

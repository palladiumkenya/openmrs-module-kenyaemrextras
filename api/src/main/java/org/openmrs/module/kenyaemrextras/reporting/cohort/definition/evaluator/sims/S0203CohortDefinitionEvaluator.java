...
/**
 * Evaluator for S0203CohortDefinition
 */
@Handler(supports = { S0203CohortDefinition.class })
public class S0203CohortDefinitionEvaluator implements CohortDefinitionEvaluator {
	...
	public EvaluatedCohort evaluate(CohortDefinition cohortDefinition, EvaluationContext context) throws EvaluationException {
		...
		S0203CohortDefinition definition = (S0203CohortDefinition) cohortDefinition;
		...
		String qry = SimsReportQueries.newlyDiagnosedQuery();

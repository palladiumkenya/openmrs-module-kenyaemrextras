...
import org.openmrs.module.kenyaemrextras.reporting.cohort.definition.sims.S0413CohortDefinition;
 ...
 */
@Handler(supports = { S0413CohortDefinition.class })
public class S0413CohortDefinitionEvaluator implements CohortDefinitionEvaluator {
	...
	public EvaluatedCohort evaluate(CohortDefinition cohortDefinition, EvaluationContext context) throws EvaluationException {
		...
		S0413CohortDefinition definition = (S0413CohortDefinition) cohortDefinition;
		...
		String qry = SimsReportQueries.txCurrPregnantAndBFDeliveryWithin2WeeksQuery();

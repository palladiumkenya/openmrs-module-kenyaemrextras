...
import org.openmrs.module.kenyaemrextras.reporting.cohort.definition.sims.S0225CohortDefinition;
...
/**
 * Evaluator for S0225CohortDefinition: TB
 */
@Handler(supports = { S0225CohortDefinition.class })
public class S0225CohortDefinitionEvaluator implements CohortDefinitionEvaluator {
	...
	public EvaluatedCohort evaluate(CohortDefinition cohortDefinition, EvaluationContext context) throws EvaluationException {
		...
		S0225CohortDefinition definition = (S0225CohortDefinition) cohortDefinition;
		...
		String qry = SimsReportQueries.pedListedAsContacts();

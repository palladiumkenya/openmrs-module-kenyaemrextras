...
import org.openmrs.module.kenyaemrextras.reporting.cohort.definition.sims.S0229CohortDefinition;
...
/**
 * Evaluator for S0229CohortDefinition: HIV-positive TXC peds patients <15 years old with presumed
 * TB
 */
@Handler(supports = { S0229CohortDefinition.class })
public class S0229CohortDefinitionEvaluator implements CohortDefinitionEvaluator {
	...
	public EvaluatedCohort evaluate(CohortDefinition cohortDefinition, EvaluationContext context) throws EvaluationException {
		...
		S0229CohortDefinition definition = (S0229CohortDefinition) cohortDefinition;
		...
		String qry = SimsReportQueries.pedscurrentOnARTWithPresumptiveTBQuery();

...
import org.openmrs.module.kenyaemrextras.reporting.data.definition.mortalityAuditTool.HeiInfantFeedingDataDefinition;
...
/**
 * Evaluates Infant feeding DataDefinition
 */
@Handler(supports = HeiInfantFeedingDataDefinition.class, order = 50)
public class HeiInfantFeedingDataEvaluator implements PersonDataEvaluator {
	...
	public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context)
		...
		String qry = "select d.patient_id,\n"
		        + "  (case max(hf.infant_feeding) when 5526 then 'EBF' when 1595 then 'ERF' when 6046 then 'MF' else '' end) as infant_feeding\n"

...
import org.openmrs.module.kenyaemrextras.reporting.data.definition.HTSEntryPointDataDefinition;
 ...
 */
@Handler(supports = HTSEntryPointDataDefinition.class, order = 50)
public class HTSEntryPointDataEvaluator implements PersonDataEvaluator {

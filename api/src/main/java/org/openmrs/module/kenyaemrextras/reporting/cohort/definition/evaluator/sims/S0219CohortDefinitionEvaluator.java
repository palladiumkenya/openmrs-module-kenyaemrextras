...
/**
 * HIV positve Peds who missed their most recent appointments age < 15 yrs.
 */
@Handler(supports = { S0219CohortDefinition.class })
public class S0219CohortDefinitionEvaluator implements CohortDefinitionEvaluator {
	...
	public EvaluatedCohort evaluate(CohortDefinition cohortDefinition, EvaluationContext context) throws EvaluationException {
		...
		S0219CohortDefinition definition = (S0219CohortDefinition) cohortDefinition;
		...
		String qry = SimsReportQueries.pedMissedAppointment();

...
/**
 * TB Date of Diagnosis Evaluator
 */
@Handler(supports = TbDateOfDiagnosisDataDefinition.class, order = 50)
public class TbDateOfDiagnosisDataEvaluator implements PersonDataEvaluator {
	...
	public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context)
		...
		String qry = "select tb.patient_id, date(tb.visit_date) as tb_diagnosis_date\n"

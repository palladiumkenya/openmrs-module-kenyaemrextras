...
/**
 * TB Patient Hiv Test Done Evaluator
 */
@Handler(supports = TbPatientHivTestDoneDataDefinition.class, order = 50)
public class TbPatientHivTestDoneDataEvaluator implements PersonDataEvaluator {
	...
	public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context)
		...
		String qry = "select d.patient_id,\n"
		        + "  if(tf.hiv_status is not null,'Yes',\n"
		        + "        if(ht.patient_id is not null,'Yes','No')) as hiv_test_done\n"

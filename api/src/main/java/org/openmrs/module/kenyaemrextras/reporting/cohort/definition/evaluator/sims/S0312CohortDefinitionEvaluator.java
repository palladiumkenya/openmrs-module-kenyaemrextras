 ...
 */
@Handler(supports = { S0312CohortDefinition.class })
public class S0312CohortDefinitionEvaluator implements CohortDefinitionEvaluator {
	...
	public EvaluatedCohort evaluate(CohortDefinition cohortDefinition, EvaluationContext context) throws EvaluationException {
		...
		S0312CohortDefinition definition = (S0312CohortDefinition) cohortDefinition;
		...
		String qry = SimsReportQueries.KpUnSupressedVLQuery();

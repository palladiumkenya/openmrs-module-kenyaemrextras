...
import org.openmrs.module.kenyaemrextras.reporting.data.definition.mortalityAuditTool.HeiFirstPCRTestDateDataDefinition;
...
/**
 * Evaluates First PCR Test Date DataDefinition
 */
@Handler(supports = HeiFirstPCRTestDateDataDefinition.class, order = 50)
public class HeiFirstPCRTestDateDataEvaluator implements PersonDataEvaluator {

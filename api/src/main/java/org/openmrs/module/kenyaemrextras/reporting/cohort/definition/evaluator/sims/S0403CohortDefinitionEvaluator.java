...
import org.openmrs.module.kenyaemrextras.reporting.cohort.definition.sims.S0403CohortDefinition;
...
/**
 * Evaluator for CohortDefinition: Pregnant/Breastfeeding (BF) women on ART >6 months.
 */
@Handler(supports = { S0403CohortDefinition.class })
public class S0403CohortDefinitionEvaluator implements CohortDefinitionEvaluator {
	...
	public EvaluatedCohort evaluate(CohortDefinition cohortDefinition, EvaluationContext context) throws EvaluationException {
		...
		S0403CohortDefinition definition = (S0403CohortDefinition) cohortDefinition;
		...
		String qry = SimsReportQueries.txCurrPregBFOver6MonthsART();

...
import org.openmrs.module.kenyaemrextras.reporting.data.definition.mortalityAuditTool.HeiDevelopmentalAssessmentDataDefinition;
...
/**
 * Evaluates Developmental Assessment DataDefinition
 */
@Handler(supports = HeiDevelopmentalAssessmentDataDefinition.class, order = 50)
public class HeiDevelopmentalAssessmentDataEvaluator implements PersonDataEvaluator {
	...
	public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context)
		...
		String qry = "select  hf.patient_id,\n"
		        + "  (case max(hf.review_of_systems_developmental) when 1115 then \"Normal(N)\"\n"
		        + "                                             when 6022 then \"Delayed(D)\"\n"
		        + "                                             when 6025 then \"Regressed(R)\" else \"Not done\" end)  as developmental_assessment\n"

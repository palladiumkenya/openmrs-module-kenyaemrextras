...
/**
 * Evaluator for CohortDefinition: HIV-positive peds patients <15 years old and on ART ≥12 months.
 */
@Handler(supports = { S0226To28CohortDefinition.class })
public class S0226To28CohortDefinitionEvaluator implements CohortDefinitionEvaluator {
	...
	public EvaluatedCohort evaluate(CohortDefinition cohortDefinition, EvaluationContext context) throws EvaluationException {
		...
		S0226To28CohortDefinition definition = (S0226To28CohortDefinition) cohortDefinition;
		...
		String qry = SimsReportQueries.pedsCurrentlyOnArtMoreThan12MonthsQuery();

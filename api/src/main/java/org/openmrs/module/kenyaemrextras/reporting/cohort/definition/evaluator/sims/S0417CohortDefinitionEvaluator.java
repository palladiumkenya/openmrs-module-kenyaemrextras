...
import org.openmrs.module.kenyaemrextras.reporting.cohort.definition.sims.S0415CohortDefinition;
import org.openmrs.module.kenyaemrextras.reporting.cohort.definition.sims.S0417CohortDefinition;
...
/**
 * Evaluator for CohortDefinition: HIV-Exposed Infants (HEI): Most recent HIV-infected infants (i.e.
 * born 3 or more months prior to the SIMS assessment and up to the last 12 months prior to today’s
 * SIMS assessment) who had an initial positive virologic test result.
 */
@Handler(supports = { S0417CohortDefinition.class })
public class S0417CohortDefinitionEvaluator implements CohortDefinitionEvaluator {
	...
	public EvaluatedCohort evaluate(CohortDefinition cohortDefinition, EvaluationContext context) throws EvaluationException {
		...
		S0417CohortDefinition definition = (S0417CohortDefinition) cohortDefinition;
		...
		String qry = SimsReportQueries.newPosHEIs3To12MonthsOldInitialVirologicResult();

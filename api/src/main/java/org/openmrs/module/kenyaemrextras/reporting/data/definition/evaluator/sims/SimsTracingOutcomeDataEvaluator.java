...
/**
 * Evaluates tracing outcome during a reporting period
 */
@Handler(supports = SimsTracingOutcomeDataDefinition.class, order = 50)
public class SimsTracingOutcomeDataEvaluator implements PersonDataEvaluator {
	...
	public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context)
		...
		String qry = "select t.patient_id,\n"
		        + "(case mid(max(concat(t.visit_date, t.tracing_outcome)), 11) when 1267 then 'Contact' when 1118 then 'No Contact' else '' end)\n"

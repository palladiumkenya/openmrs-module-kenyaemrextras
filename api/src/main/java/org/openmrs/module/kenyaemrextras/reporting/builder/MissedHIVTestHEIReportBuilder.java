...
@Component
@Builds({ "kenyaemrextras.mchms.report.missedHIVtestHEI" })
public class MissedHIVTestHEIReportBuilder extends AbstractReportBuilder {
	...
	protected List<Mapped<DataSetDefinition>> buildDataSets(ReportDescriptor descriptor, ReportDefinition report) {
		return Arrays.asList(ReportUtils.map(missedHIVTestHEIDataSetDefinition(),

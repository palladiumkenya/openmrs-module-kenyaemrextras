 ...
 */
@Handler(supports = ValidVLDateDataDefinition.class, order = 50)
public class ValidVLDateDataEvaluator implements PersonDataEvaluator {
	...
	public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context)
		...
		String qry = "select a.patient_id,\n"
		        ...
		        + "              date_sub(a.death_date, interval 12 MONTH) and a.death_date, a.vl_result_date, '') as had_valid_vl\n"

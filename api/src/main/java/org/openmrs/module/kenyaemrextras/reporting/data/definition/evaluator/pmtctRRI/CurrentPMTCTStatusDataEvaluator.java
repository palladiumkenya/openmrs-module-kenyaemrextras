...
public class CurrentPMTCTStatusDataEvaluator implements PersonDataEvaluator {
	...
	public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context)
		...
		String qry = "select f.patient_id,\n"
		        ...
		        + "                              where p.visit_date <= date(CURRENT_DATE)\n"
		        ...
		        + "                              where a.visit_date <= date(CURRENT_DATE) and a.maturity <= 42 or maturity is null\n"

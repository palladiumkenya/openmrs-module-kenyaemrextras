...
import org.openmrs.module.kenyaemrextras.reporting.cohort.definition.sims.S0321CohortDefinition;
...
/**
 * Evaluator for S0321CohortDefinition
 */
@Handler(supports = { S0321CohortDefinition.class })
public class S0321CohortDefinitionEvaluator implements CohortDefinitionEvaluator {
	...
	public EvaluatedCohort evaluate(CohortDefinition cohortDefinition, EvaluationContext context) throws EvaluationException {
		...
		S0321CohortDefinition definition = (S0321CohortDefinition) cohortDefinition;
		...
		String qry = SimsReportQueries.keyPopsOnARTReceivedHighImpactServices();

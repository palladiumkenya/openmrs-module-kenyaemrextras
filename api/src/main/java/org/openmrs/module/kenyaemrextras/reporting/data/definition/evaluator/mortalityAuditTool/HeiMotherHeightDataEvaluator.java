...
import org.openmrs.module.kenyaemrextras.reporting.data.definition.mortalityAuditTool.HeiMotherHeightDataDefinition;
...
/**
 * Evaluates Height Date
 */
@Handler(supports = HeiMotherHeightDataDefinition.class, order = 50)
public class HeiMotherHeightDataEvaluator implements PersonDataEvaluator {
	...
	public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context)
		...
		String qry = "select distinct r.person_a,\n"
		        + " coalesce(tr.height,fup.height,v.height,pnc.height) as height\n"

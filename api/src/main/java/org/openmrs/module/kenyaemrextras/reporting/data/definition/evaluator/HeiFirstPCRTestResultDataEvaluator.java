...
import org.openmrs.module.kenyaemrextras.reporting.data.definition.HeiFirstPCRTestDateDataDefinition;
...
/**
 * Evaluates First PCR Test Result DataDefinition
 */
@Handler(supports = HeiFirstPCRTestResultDataDefinition.class, order = 50)
public class HeiFirstPCRTestResultDataEvaluator implements PersonDataEvaluator {
	...
	public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context)
		...
		String qry = "select x.patient_id,\n"
		        ...
		        + "       and  x.lab_test = 1030 and x.order_reason = 1040\n" + "group by x.patient_id;";

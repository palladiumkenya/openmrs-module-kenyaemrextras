...
import org.openmrs.module.kenyaemrextras.reporting.data.definition.mortalityAuditTool.VLDateForCaregiverDataDefinition;
import org.openmrs.module.kenyaemrextras.reporting.data.definition.mortalityAuditTool.ValidVLDateDataDefinition;
...
/**
 * Evaluates date of Valid VL result date Data Definition
 */
@Handler(supports = VLDateForCaregiverDataDefinition.class, order = 50)
public class VLDateForCaregiverDataEvaluator implements PersonDataEvaluator {
	...
	public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context)
		...
		String qry = "select a.child,\n"
		        + "       if(a.latest_lab_visit_date is not null, a.latest_lab_visit_date,'Unknown') as caregiver_vl_date\n"

...
import org.openmrs.module.kenyaemrextras.reporting.cohort.definition.sims.S0324CohortDefinition;
...
/**
 * Evaluator for S0324CohortDefinition
 */
@Handler(supports = { S0324CohortDefinition.class })
public class S0324CohortDefinitionEvaluator implements CohortDefinitionEvaluator {
	...
	public EvaluatedCohort evaluate(CohortDefinition cohortDefinition, EvaluationContext context) throws EvaluationException {
		...
		S0324CohortDefinition definition = (S0324CohortDefinition) cohortDefinition;
		...
		String qry = SimsReportQueries.txCurrKPsCacxPositive();

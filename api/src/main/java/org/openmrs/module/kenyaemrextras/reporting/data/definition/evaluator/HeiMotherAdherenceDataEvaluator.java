...
import org.openmrs.module.kenyaemrextras.reporting.data.definition.HeiMotherAdherenceDataDefinition;
import org.openmrs.module.kenyaemrextras.reporting.data.definition.HeiMotherPwpDisclosureDataDefinition;
 ...
 * Evaluates Adherence
 */
@Handler(supports = HeiMotherAdherenceDataDefinition.class, order = 50)
public class HeiMotherAdherenceDataEvaluator implements PersonDataEvaluator {
	...
	public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context)
		...
		String qry = "select distinct r.person_a,\n"
		        + "  (case max(fup.arv_adherence) when 159405 then 'Good' when 163794 then 'Fair' when 159407 then 'Poor' else \"\" end) as mother_adherence_status\n"

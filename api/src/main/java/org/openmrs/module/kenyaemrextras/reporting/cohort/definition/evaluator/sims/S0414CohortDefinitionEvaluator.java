...
import org.openmrs.module.kenyaemrextras.reporting.cohort.definition.sims.S0414CohortDefinition;
...
/**
 * Evaluator for CohortDefinition: HIV-positive Pregnant and breastfeeding patients : On ART months
 */
@Handler(supports = { S0414CohortDefinition.class })
public class S0414CohortDefinitionEvaluator implements CohortDefinitionEvaluator {
	...
	public EvaluatedCohort evaluate(CohortDefinition cohortDefinition, EvaluationContext context) throws EvaluationException {
		...
		S0414CohortDefinition definition = (S0414CohortDefinition) cohortDefinition;
		...
		String qry = SimsReportQueries.txCurrPregnantAndBreastfeedingDelivery12MonthsQuery();

...
import org.openmrs.module.kenyaemrextras.reporting.data.definition.mortalityAuditTool.HeiMotherWeightDataDefinition;
...
/**
 * Evaluates Weight Date
 */
@Handler(supports = HeiMotherWeightDataDefinition.class, order = 50)
public class HeiMotherWeightDataEvaluator implements PersonDataEvaluator {
	...
	public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context)
		...
		String qry = "select distinct r.person_a,\n"
		        + "  coalesce(tr.weight,fup.weight,v.weight,pnc.weight) as weight\n"

...
import org.openmrs.module.kenyaemrextras.reporting.data.definition.sims.SimsPregBFAllContactTestingStatusDataDefinition;
...
/**
 * Evaluates whether HIV-positive pregnant and breastfeeding patients on ART ≥12 months have a
 * documentation of HIV testing or HIV status of all elicited partner(s)
 */
@Handler(supports = SimsPregBFAllContactTestingStatusDataDefinition.class, order = 50)
public class SimsPregBFAllContactTestingStatusDataEvaluator implements PersonDataEvaluator {

...
import org.openmrs.module.kenyaemrextras.reporting.data.definition.mortalityAuditTool.HeiMotherMuacDataDefinition;
 ...
 * Evaluates Muac Date
 */
@Handler(supports = HeiMotherMuacDataDefinition.class, order = 50)
public class HeiMotherMuacDataEvaluator implements PersonDataEvaluator {
	...
	public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context)
		...
		String qry = "select distinct r.person_a,\n"
		        + "  coalesce(tr.muac,fup.muac,v.muac,pnc.muac) as muac\n"

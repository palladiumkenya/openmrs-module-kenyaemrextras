...
import org.openmrs.module.kenyaemrextras.reporting.cohort.definition.sims.S0404CohortDefinition;
import org.openmrs.module.kenyaemrextras.reporting.cohort.definition.sims.S0412CohortDefinition;
...
/**
 * Evaluator for CohortDefinition: Pregnant/Breastfeeding (BF) women on ART ≥12 months with
 * virologic non-suppression.
 */
@Handler(supports = { S0404CohortDefinition.class })
public class S0404CohortDefinitionEvaluator implements CohortDefinitionEvaluator {
	...
	public EvaluatedCohort evaluate(CohortDefinition cohortDefinition, EvaluationContext context) throws EvaluationException {
		...
		S0404CohortDefinition definition = (S0404CohortDefinition) cohortDefinition;
		...
		String qry = SimsReportQueries.txCurrPregBFOver12MonthsARTUnsuppressed();

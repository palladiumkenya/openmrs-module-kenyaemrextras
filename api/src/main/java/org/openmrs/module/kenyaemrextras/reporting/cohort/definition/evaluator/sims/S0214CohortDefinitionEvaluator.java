...
import org.openmrs.module.kenyaemrextras.reporting.cohort.definition.sims.S0214CohortDefinition;
...
/**
 * Evaluator for S0214CohortDefinition: Adult ART patients: Review 10 referral records (individual
 * or logbook) for any 10 clients/beneficiaries from the last three months.
 */
@Handler(supports = { S0214CohortDefinition.class })
public class S0214CohortDefinitionEvaluator implements CohortDefinitionEvaluator {
	...
	public EvaluatedCohort evaluate(CohortDefinition cohortDefinition, EvaluationContext context) throws EvaluationException {
		...
		S0214CohortDefinition definition = (S0214CohortDefinition) cohortDefinition;
		...
		String qry = SimsReportQueries.adultARTClientsReceivedHighImpactServices();

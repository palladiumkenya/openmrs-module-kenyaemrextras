 ...
 * ART ≥12 months.
 */
@Handler(supports = { S02012CohortDefinition.class })
public class S02012CohortDefinitionEvaluator implements CohortDefinitionEvaluator {
	...
	public EvaluatedCohort evaluate(CohortDefinition cohortDefinition, EvaluationContext context) throws EvaluationException {
		...
		S02012CohortDefinition definition = (S02012CohortDefinition) cohortDefinition;
		...
		String qry = SimsReportQueries.currentOnARTWithPresumptiveTBQuery();

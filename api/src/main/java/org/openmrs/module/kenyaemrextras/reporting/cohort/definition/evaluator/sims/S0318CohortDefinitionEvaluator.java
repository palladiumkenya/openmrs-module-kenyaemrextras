...
/**
 * Evaluator for S0318CohortDefinition
 */
@Handler(supports = { S0318CohortDefinition.class })
public class S0318CohortDefinitionEvaluator implements CohortDefinitionEvaluator {
	...
	public EvaluatedCohort evaluate(CohortDefinition cohortDefinition, EvaluationContext context) throws EvaluationException {
		...
		S0318CohortDefinition definition = (S0318CohortDefinition) cohortDefinition;
		...
		String qry = SimsReportQueries.txCurrKPsOnTXAtleast12Months();

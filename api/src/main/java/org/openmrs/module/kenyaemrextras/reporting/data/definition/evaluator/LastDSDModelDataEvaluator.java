...
/**
 * Evaluates last DSD model Data Definition
 */
@Handler(supports = LastDSDModelDataDefinition.class, order = 50)
public class LastDSDModelDataEvaluator implements PersonDataEvaluator {

...
public class FinalHTSResultGivenDataEvaluator implements PersonDataEvaluator {
	...
	public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context)
		...
		String qry = "select t.patient_id, mid(max(concat(t.visit_date,t.patient_given_result)),11) as final_test_result_given from kenyaemr_etl.etl_hts_test t where date(t.visit_date) <=\n"

...
import org.openmrs.module.kenyaemrextras.reporting.cohort.definition.sims.S0232CohortDefinition;
...
/**
 * Evaluator for S0232CohortDefinition: HIV-positive TXCURR peds patients <15 years olD
 */
@Handler(supports = { S0232CohortDefinition.class })
public class S0232CohortDefinitionEvaluator implements CohortDefinitionEvaluator {
	...
	public EvaluatedCohort evaluate(CohortDefinition cohortDefinition, EvaluationContext context) throws EvaluationException {
		...
		S0232CohortDefinition definition = (S0232CohortDefinition) cohortDefinition;
		...
		String qry = SimsReportQueries.pedsCurrentlyOnArtQuery();

...
public class DaysMissedAppointmentDateBasedDataEvaluator implements PersonDataEvaluator {
	...
	public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context)
		...
		String qry = "select a.patient_id,a.days_missed from (select r.patient_id,r.return_date,r.next_appointment_date,\n"
		        + "                                 if(timestampdiff(DAY,r.next_appointment_date,r.return_date) > 0,timestampdiff(DAY,r.next_appointment_date,r.return_date),'') as days_missed\n"
		        + "from(\n"

...
/**
 * Evaluator for S0217CohortDefinition
 */
@Handler(supports = { S0217CohortDefinition.class })
public class S0217CohortDefinitionEvaluator implements CohortDefinitionEvaluator {
	...
	public EvaluatedCohort evaluate(CohortDefinition cohortDefinition, EvaluationContext context) throws EvaluationException {
		...
		S0217CohortDefinition definition = (S0217CohortDefinition) cohortDefinition;
		...
		String qry = SimsReportQueries.adultsOnArtScreenedForCervicalCancerQuery();

...
/**
 * Evaluates date a patient was diagnosed positive
 */
@Handler(supports = SimsHivDiagnosisDateDataDefinition.class, order = 50)
public class SimsHivDiagnosisDateDataEvaluator implements PersonDataEvaluator {

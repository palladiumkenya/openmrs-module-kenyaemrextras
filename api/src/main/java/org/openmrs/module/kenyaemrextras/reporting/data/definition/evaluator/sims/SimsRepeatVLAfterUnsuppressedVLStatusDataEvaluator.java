 ...
 * virologic non-suppression; KHP3:3819 Updated Query to accurately check if repeat VL exists and if
 * so, was it done within 3 months after reporting of previous unsuppressed VL. <= 3 months = 'Y', >
 * 3 months ='No' and missing VL = 'N/A'
 */

 ...
 */
@Handler(supports = LastDefaulterTracingDateBasedDateDataDefinition.class, order = 50)
public class LastDefaulterTracingDateBasedDateDataEvaluator implements PersonDataEvaluator {
	...
	public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context)
		...
		String qry = "select patient_id,\n" + "date(max(visit_date)) as last_tracing_date\n"

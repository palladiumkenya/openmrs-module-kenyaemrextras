...
/**
 * Evaluator for CohortDefinition: Pregnant/Breastfeeding (BF) women on ART ≥12 months.
 */
@Handler(supports = { S0407CohortDefinition.class })
public class S0407CohortDefinitionEvaluator implements CohortDefinitionEvaluator {
	...
	public EvaluatedCohort evaluate(CohortDefinition cohortDefinition, EvaluationContext context) throws EvaluationException {
		...
		S0407CohortDefinition definition = (S0407CohortDefinition) cohortDefinition;
		...
		String qry = SimsReportQueries.txCurrPregBFOver12MonthsART();

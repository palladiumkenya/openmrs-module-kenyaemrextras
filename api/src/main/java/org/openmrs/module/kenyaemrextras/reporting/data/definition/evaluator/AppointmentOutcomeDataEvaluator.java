...
public class AppointmentOutcomeDataEvaluator implements PersonDataEvaluator {
	...
	public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context)
		...
		String qry = "\n" +
				...
				"             if(r.app_visit = r.return_date,'Never Returned',(case when 0 > datediff(return_date, r.next_appointment_date) then 'Returned early'\n" +
				...
				"                 and f5.visit_date > f4.visit_date\n" +

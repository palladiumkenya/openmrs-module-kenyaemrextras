...
import org.openmrs.module.kenyaemrextras.reporting.data.definition.sims.SimsPedSmearCultureXpertResultsDataDefinition;
...
/**
 * Evaluates whether there is documentation of smear microscopy, culture or Xpert MTB/RIF or chest
 * xray results
 */
@Handler(supports = SimsPedSmearCultureXpertResultsDataDefinition.class, order = 50)
public class SimsPedSmearCultureXpertResultsDataEvaluator implements PersonDataEvaluator {
	...
	public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context)
		...
		String qry = "select t.patient_id,\n"
		        + "if((testResult in (162203,162204,162104,703,1362,1363,1364,664) or genexpert_result in (162204,664)\n"
		        + " or spatum_smear_result in(664, 703)  or chestXrayResult in (1115,152526)),'Y','N'  ) from (\n"
		        ...
		        + "  mid(max(concat(fup.visit_date,fup.chest_xray_result )),11) as chestXrayResult,\n"

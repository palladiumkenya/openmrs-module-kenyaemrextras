...
import org.openmrs.module.kenyaemrextras.reporting.data.definition.mortalityAuditTool.ValidVLResultDataDefinition;
...
/**
 * Valid VL result Data Definition
 */
@Handler(supports = ValidVLResultDataDefinition.class, order = 50)
public class ValidVLResultDataEvaluator implements PersonDataEvaluator {
	...
	public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context)
		...
		String qry = "select a.patient_id,\n"
		        ...
		        + "              date_sub(a.death_date, interval 12 MONTH) and a.death_date, if(vl_result between 200 and 999,'200-999',if(vl_result > 1000,'>1000',if(a.vl_result = 'LDL','LDL',a.vl_result))), '') as had_valid_vl\n"

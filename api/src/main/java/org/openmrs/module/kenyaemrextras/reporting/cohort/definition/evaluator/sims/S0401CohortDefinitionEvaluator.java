...
import org.openmrs.module.kenyaemrextras.reporting.cohort.definition.sims.S0401CohortDefinition;
...
/**
 * Evaluator for S0401CohortDefinition
 */
@Handler(supports = { S0401CohortDefinition.class })
public class S0401CohortDefinitionEvaluator implements CohortDefinitionEvaluator {
	...
	public EvaluatedCohort evaluate(CohortDefinition cohortDefinition, EvaluationContext context) throws EvaluationException {
		...
		S0401CohortDefinition definition = (S0401CohortDefinition) cohortDefinition;
		...
		String qry = SimsReportQueries.txNewPregnantBreastFeedingRetestDocumentation();

...
import org.openmrs.module.kenyaemrextras.reporting.cohort.definition.sims.S0407CohortDefinition;
 ...
 * SIMS assessment).
 */
@Handler(supports = { S0415CohortDefinition.class })
public class S0415CohortDefinitionEvaluator implements CohortDefinitionEvaluator {
	...
	public EvaluatedCohort evaluate(CohortDefinition cohortDefinition, EvaluationContext context) throws EvaluationException {
		...
		S0415CohortDefinition definition = (S0415CohortDefinition) cohortDefinition;
		...
		String qry = SimsReportQueries.newPositiveHEIs3To12MonthsOld();

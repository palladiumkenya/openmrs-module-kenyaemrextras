...
/**
 * Evaluator for S0202CohortDefinition
 */
@Handler(supports = { S0202CohortDefinition.class })
public class S0202CohortDefinitionEvaluator implements CohortDefinitionEvaluator {
	...
	public EvaluatedCohort evaluate(CohortDefinition cohortDefinition, EvaluationContext context) throws EvaluationException {
		...
		S0202CohortDefinition definition = (S0202CohortDefinition) cohortDefinition;
		...
		String qry = SimsReportQueries.missedAppointmentQuery();

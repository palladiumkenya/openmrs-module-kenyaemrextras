...
import org.openmrs.module.kenyaemrextras.reporting.data.definition.HeiFirstPCRTestResultDataDefinition;
import org.openmrs.module.kenyaemrextras.reporting.data.definition.HeiSecondPCRTestResultDataDefinition;
...
/**
 * Evaluates Second PCR Test Result DataDefinition
 */
@Handler(supports = HeiSecondPCRTestResultDataDefinition.class, order = 50)
public class HeiSecondPCRTestResultDataEvaluator implements PersonDataEvaluator {
	...
	public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context)
		...
		String qry = "select x.patient_id,\n"
		        ...
		        + "       and  x.lab_test = 1030 and x.order_reason = 1326\n" + "group by x.patient_id;";

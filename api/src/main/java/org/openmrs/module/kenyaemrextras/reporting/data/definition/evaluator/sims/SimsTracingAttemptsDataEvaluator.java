 ...
 */
@Handler(supports = SimsTracingAttemptsDataDefinition.class, order = 50)
public class SimsTracingAttemptsDataEvaluator implements PersonDataEvaluator {
	...
	public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context)
		...
		String qry = "select trace.patient_id,\n"
		        + "count(*) as attempts \n"

...
/**
 * Evaluator for adults newly initiated on ART in the last 3 months
 */
@Handler(supports = { S0201CohortDefinition.class })
public class S0201CohortDefinitionEvaluator implements CohortDefinitionEvaluator {
	...
	public EvaluatedCohort evaluate(CohortDefinition cohortDefinition, EvaluationContext context) throws EvaluationException {
		...
		S0201CohortDefinition definition = (S0201CohortDefinition) cohortDefinition;

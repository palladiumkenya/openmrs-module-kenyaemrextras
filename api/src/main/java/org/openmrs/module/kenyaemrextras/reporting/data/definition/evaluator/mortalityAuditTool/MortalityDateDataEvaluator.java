...
import org.openmrs.module.kenyaemrextras.reporting.data.definition.mortalityAuditTool.MortalityDateDataDefinition;
 ...
 */
@Handler(supports = MortalityDateDataDefinition.class, order = 50)
public class MortalityDateDataEvaluator implements PersonDataEvaluator {
	...
	public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context)
		...
		String qry = "select disc.patient_id, coalesce(date(disc.date_died),date(disc.effective_discontinuation_date),date(disc.visit_date)) as date_of_death\n"
		        ...
		        + "where disc.discontinuation_reason in (160432,160034);";

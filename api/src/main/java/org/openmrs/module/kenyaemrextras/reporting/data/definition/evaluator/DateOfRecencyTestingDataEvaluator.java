...
/**
 * Evaluates Date of Recency Testing Data Definition
 */
@Handler(supports = DateOfRecencyTestingDataDefinition.class, order = 50)
public class DateOfRecencyTestingDataEvaluator implements PersonDataEvaluator {
	...
	public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context)
		...
		String qry = "select pi.patient_id,pi.date_created\n" + "from patient_identifier pi\n"
		        + "inner join patient_identifier_type pt on pt.patient_identifier_type_id = pi.identifier_type\n"
		        + "                                                 and pt.uuid = 'fd52829a-75d2-4732-8e43-4bff8e5b4f1a'\n"

...
import org.openmrs.module.kenyaemrextras.reporting.cohort.definition.sims.S0319CohortDefinition;
import org.openmrs.module.kenyaemrextras.reporting.cohort.definition.sims.S0402CohortDefinition;
...
/**
 * Evaluator for S0402CohortDefinition
 */
@Handler(supports = { S0402CohortDefinition.class })
public class S0402CohortDefinitionEvaluator implements CohortDefinitionEvaluator {
	...
	public EvaluatedCohort evaluate(CohortDefinition cohortDefinition, EvaluationContext context) throws EvaluationException {
		...
		S0402CohortDefinition definition = (S0402CohortDefinition) cohortDefinition;
		...
		String qry = SimsReportQueries.txCurrPregnantBreastFeedingMissedApp();

...
import org.openmrs.module.kenyaemrextras.reporting.data.definition.mortalityAuditTool.RecentCD4DateDataDefinition;
...
/**
 * Evaluates date of Recent CD4 Data Definition
 */
@Handler(supports = RecentCD4DateDataDefinition.class, order = 50)
public class RecentCD4DateDataEvaluator implements PersonDataEvaluator {

 ...
 */
@Handler(supports = TBInvestigationsDoneDataDefinition.class, order = 50)
public class TBInvestigationsDoneDataEvaluator implements PersonDataEvaluator {
	...
	public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context)
		...
		String qry = "select s.patient_id,\n"
		        + "       if(l.patient_id is not null and l.tb_test_date >= s.tb_screening_date, 'Yes', 'No') as tb_investigations_done\n"
		        ...
		        + "      where a.person_present = 978 and a.max_visit >= date(:startDate)) s\n"
		        ...
		        + "                    where l.lab_test in (162202, 307, 1465) and l.visit_date >= date(:startDate)\n"

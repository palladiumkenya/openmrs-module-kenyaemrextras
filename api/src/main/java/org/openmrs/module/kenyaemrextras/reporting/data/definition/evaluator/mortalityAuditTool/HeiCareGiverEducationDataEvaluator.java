...
import org.openmrs.module.kenyaemrextras.reporting.data.definition.mortalityAuditTool.HeiCareGiverEducationDataDefinition;
...
/**
 * Evaluates a HeiPrimaryCareGiverDataDefinition
 */
@Handler(supports = HeiCareGiverEducationDataDefinition.class, order = 50)
public class HeiCareGiverEducationDataEvaluator implements PersonDataEvaluator {
	...
	public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context)
		...
		String qry = "select distinct r.person_a,\n"
		        + "                d.education_level as careGiverRelationship\n"

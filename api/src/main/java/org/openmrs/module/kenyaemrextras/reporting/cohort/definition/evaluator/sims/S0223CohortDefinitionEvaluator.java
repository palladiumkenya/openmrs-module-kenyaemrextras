...
import org.openmrs.module.kenyaemrextras.reporting.cohort.definition.sims.S0223CohortDefinition;
...
/**
 * Evaluator for S0223CohortDefinition
 */
@Handler(supports = { S0223CohortDefinition.class })
public class S0223CohortDefinitionEvaluator implements CohortDefinitionEvaluator {
	...
	public EvaluatedCohort evaluate(CohortDefinition cohortDefinition, EvaluationContext context) throws EvaluationException {
		...
		S0223CohortDefinition definition = (S0223CohortDefinition) cohortDefinition;
		...
		String qry = SimsReportQueries.pedUnsupressedVLQuery();

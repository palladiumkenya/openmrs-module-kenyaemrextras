...
import org.openmrs.module.kenyaemrextras.reporting.cohort.definition.sims.S0501CohortDefinition;
...
/**
 * Evaluates S0501CohortDefinition
 */
@Handler(supports = { S0501CohortDefinition.class })
public class S0501CohortDefinitionEvaluator implements CohortDefinitionEvaluator {
	...
	public EvaluatedCohort evaluate(CohortDefinition cohortDefinition, EvaluationContext context) throws EvaluationException {
		...
		S0501CohortDefinition definition = (S0501CohortDefinition) cohortDefinition;
		...
		String qry = SimsReportQueries.vmmcClientsQuery();

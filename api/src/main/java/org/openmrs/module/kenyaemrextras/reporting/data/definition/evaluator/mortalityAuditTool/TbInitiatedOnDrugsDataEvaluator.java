...
/**
 * TB Initiated on On Anti TB Evaluator
 */
@Handler(supports = TbInitiatedOnDrugsDataDefinition.class, order = 50)
public class TbInitiatedOnDrugsDataEvaluator implements PersonDataEvaluator {
	...
	public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context)
		...
		String qry = "select d.patient_id,\n"
		        + "  if(de.date_started is not null,'Yes',(case tb.started_anti_TB when 1065 then 'Yes'\n"
		        + "                                when 1066 then 'No' else '' end)) as started_anti_TB\n"
		        ...
		        + "  left join kenyaemr_etl.etl_tb_screening tb on d.patient_id = tb.patient_id\n"

...
import org.openmrs.module.kenyaemrextras.reporting.cohort.definition.sims.S0318CohortDefinition;
...
/**
 * Evaluator for S0319CohortDefinition
 */
@Handler(supports = { S0319CohortDefinition.class })
public class S0319CohortDefinitionEvaluator implements CohortDefinitionEvaluator {
	...
	public EvaluatedCohort evaluate(CohortDefinition cohortDefinition, EvaluationContext context) throws EvaluationException {
		...
		S0319CohortDefinition definition = (S0319CohortDefinition) cohortDefinition;
		...
		String qry = SimsReportQueries.txCurrKPsWithPresumtiveTB();

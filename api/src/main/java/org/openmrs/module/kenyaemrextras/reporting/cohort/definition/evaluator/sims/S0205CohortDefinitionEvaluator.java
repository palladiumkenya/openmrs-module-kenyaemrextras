...
/**
 * Evaluator for S0205CohortDefinition:on art clients with non virologic suppression (VL > 1000)
 */
@Handler(supports = { S0205CohortDefinition.class })
public class S0205CohortDefinitionEvaluator implements CohortDefinitionEvaluator {
	...
	public EvaluatedCohort evaluate(CohortDefinition cohortDefinition, EvaluationContext context) throws EvaluationException {
		...
		S0205CohortDefinition definition = (S0205CohortDefinition) cohortDefinition;
		...
		String qry = SimsReportQueries.unSupressedVLQuery();

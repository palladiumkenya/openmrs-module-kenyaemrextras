 ...
 */
@Handler(supports = { S0412CohortDefinition.class })
public class S0412CohortDefinitionEvaluator implements CohortDefinitionEvaluator {
	...
	public EvaluatedCohort evaluate(CohortDefinition cohortDefinition, EvaluationContext context) throws EvaluationException {
		...
		S0412CohortDefinition definition = (S0412CohortDefinition) cohortDefinition;
		...
		String qry = SimsReportQueries.txCurrPregnantAndBFPresumedTbQuery();

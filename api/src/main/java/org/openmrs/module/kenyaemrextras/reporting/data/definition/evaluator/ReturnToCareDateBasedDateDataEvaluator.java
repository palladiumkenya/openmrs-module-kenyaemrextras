...
public class ReturnToCareDateBasedDateDataEvaluator implements PersonDataEvaluator {
	...
	public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context)
		...
		String qry = "select t.patient_id,min_f1_visit_date as RTC_date\n"
		        + "from(\n"
		        ...
		        + "        group by patient_id\n"
		        + "        having\n"
		        + "            ((min_f1_visit_date > latest_tca or min_f1_visit_date is null) and latest_tca > date(latest_vis_date) AND latest_tca <= date(:endDate)\n"

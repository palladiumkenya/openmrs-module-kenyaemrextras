...
import org.openmrs.module.kenyaemrextras.reporting.data.definition.mortalityAuditTool.RecentInvalidVLDataDefinition;
...
/**
 * Recent invalid VL Data Definition
 */
@Handler(supports = RecentInvalidVLDataDefinition.class, order = 50)
public class RecentInvalidVLDataEvaluator implements PersonDataEvaluator {
	...
	public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context)
		...
		String qry = "select a.patient_id,\n"
		        + "       a.latest_visit_date as invalid_vl_date\n"
